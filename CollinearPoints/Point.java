...
public class Point implements Comparable<Point> {
    ...
    public static void main(String[] args) {
        ...
        assert base.slopeTo(p1) > base.slopeTo(p2);
        Point p11 = new Point(1, 5);
        assert p1.slopeTo(p11) == Double.NEGATIVE_INFINITY;
        Point p3 = new Point(3, 7);
        assert p2.slopeTo(p3) == Double.POSITIVE_INFINITY;
        Point p4 = new Point(3, 5);
        assert p1.slopeTo(p4) == 0;
